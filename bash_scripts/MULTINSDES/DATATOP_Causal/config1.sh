...
longdata_fname='ttl_collapsed_causal_DATATOP_nodeath_long_filled_main_file_3month.csv'
longtypes_fname='ttl_original_causal_DATATOP_nodeath_long_main_file_types.csv'
staticdata_fname='original_causal_DATATOP_nodeath_static.csv'
statictypes_fname='original_causal_DATATOP_nodeath_static_types.csv'
dosesdata_fname='collapsed_causal_DATATOP_nodeath_long_filled_rhs_3month.csv'
ps_scores_fname='OOF_Propensity_Scores.csv'
do_scores_fname='OOF_Observation_Scores.csv'
or_model_exp_name='OR_ATEmodels'
timetoevent_fname='collapsed_time_to_event_3month.csv'
survival_target_time=4 # 1 year
...
l_or_trt=1e-3 # lambda for the orthogonal regularization (treatment assignment)
l_or_do=1e-2 # lambda for the orthogonal regularization (dropout)

# Longitudinal Encoder
num_enc=1 # If 2, img feats will be used, if 3 lab test data also is used
nl_mlp_lenc=1 # Number of layers of the MLP for learning the Mean and Variance
nhidden_lenc=100 # Hidden state of the Longitudinal encoder
...
# HI-VAE
type_hivae=SLR_BL_Causal_HIVAE # If static_data=0, please use Z0_HIVAE as well
stat_ldim=10 # Static latent dimension (Z0_HIVAE)
s_dim_static=12 # Dimension of the sn of the Gaussian Mixture of the static data
...
name=Causal_MultiNSDES_DATATOP_seq