...
# Dataset
dataset_=DATATOP
longdata_fname='collapsed_long_filled_main_file_3month.csv'
longtypes_fname='original_long_main_file_types.csv'
staticdata_fname='original_static.csv'
statictypes_fname='original_static_types.csv'
dosesdata_fname='collapsed_long_filled_rhs_3month.csv'
timetoevent_fname='collapsed_time_to_event_3month.csv'
train_dir=/home/afourtoy/Datasets/collapsed_time_points/3month/
