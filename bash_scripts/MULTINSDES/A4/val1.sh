...
nruns=30
Val_Scenario_=(0 1 2 3)
# To be sure we validate it using the correct class type
real_longtypes_fname='sep_merged_scores_test_types_adapted_ordinal.csv,sep_merged_cog_test_types_adapted.csv,sep_merged_long_imgfeats_types.csv'
real_statictypes_fname='sep_merged_static_types_adapted_ordinal.csv'
...
for Val_Scenario in ${Val_Scenario_[@]}; do
    ...
    if [[ $Val_Scenario -eq 2 || $Val_Scenario -eq 3 ]]; then
