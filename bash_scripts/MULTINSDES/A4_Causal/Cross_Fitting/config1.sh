...
# Dataset
dataset_=A4_Causal
longdata_fname='Causal_scores_test.csv,Causal_cog_test.csv,Causal_long_imgfeats.csv'
longtypes_fname='Causal_scores_types_ordinal.csv,Causal_cog_types.csv,Causal_long_imgfeats_types.csv'
staticdata_fname='Causal_static_data.csv'
statictypes_fname='Causal_static_types_ordinal.csv'
dosesdata_fname='Causal_doses_data.csv'
ps_scores_fname='Manual_Propensity_Scores.csv'
...
l_or_trt=1e-2 # lambda for the orthogonal regularization (treatment assignment)
...
long_impl=1 # Defines if there is missing values in the bl data
comb_longloss=avg
...
name=Causal_MultiNSDE_OfficialParams